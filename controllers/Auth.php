	...
	public function reset_password($code = NULL)
	{
		...
		if ($user)
		{
			...
			$this->form_validation->set_rules('new', $this->lang->line('reset_password_validation_new_password_label'), 'required|min_length[' . $this->config->item('min_password_length', 'ion_auth') . ']|matches[new_confirm]', 
				[
					'required'	 => 'A new password must be filled in.',
					'min_length' => 'New password is at least 8 characters long.',
					'matches'	 => 'The new password does not match the Confirm Password.'
				]
			);
			...
			if ($this->input->post('password'))
			{
				$this->form_validation->set_rules('password', $this->lang->line('edit_user_validation_password_label'), 'required|min_length[' . $this->config->item('min_password_length', 'ion_auth') . ']|matches[password_confirm]',
					[
						...
						'min_length' => 'The minimum password is 8 characters.'
					]
				);
