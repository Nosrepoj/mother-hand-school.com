      ...
      <div id="content">
        ...
        <!-- End of Topbar -->
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-8">
						<a href="<?= base_url('admin'); ?>" class="btn btn-secondary btn-sm"><i class="fas fa-angle-left mr-1"></i>Return</a>
						<?= form_submit('submit', 'Save', ['class' => 'btn btn-primary btn-sm float-right']);?>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Click the "Logout" button to exit.</div>
