	...
	<div class="container text-center">
		...
		<div class="row pt-3">
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-4">
				<img class="" src="<?= base_url('img/jurusan/11.png') ?>" alt="">
				<h5 class="mt-2">Study</h5>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-4">
				<img class="" src="<?= base_url('img/jurusan/22.png') ?>" alt="">
				<h5 class="mt-2">Work Hard</h5>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-4">
				<img class="" src="<?= base_url('img/jurusan/33.png') ?>" alt="">
				<h5 class="mt-2">Read</h5>
			</div>
		</div>
	</div>
</div>
	...
	<div class="container">
				...
				<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
					<div class="card" style="width: 15rem; height: 24rem;">
						...
						<div class="card-body">
							...
							<a href="<?= base_url("blog/baca/$b->seo_title") ?>" class="btn btn-info btn-sm"><b>Continue Reading</b><i class="fa fa-angle-right ml-2"></i></a>
						</div>
					</div>
				</div>
			<?php endforeach ?>
		...
		<div class="row mt-4">
			<div class="col text-center">
				<a href="<?= base_url('blog') ?>" class="btn btn-secondary text-light"><b>View more</b><i class="fa fa-angle-double-right ml-2"></i></a>
			</div>
		</div>
	</div>
</div>
