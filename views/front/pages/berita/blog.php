...
<div class="jumbotron banner_area jumbotron-fluid" style="background-image: url(<?= base_url('img/banner_area/bg.jpg') ?>); ">
	<div class="container">
		<h1 class="display-4 my-auto text-light text-center">News & Events</h1>
	</div>
</div>
				...
				<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 my-3">
					<div class="card" style="width: 15rem; height: 24rem;">
						...
						<div class="card-body">
							...
							<a href="<?= base_url("blog/baca/$n->seo_title") ?>" class="btn btn-info btn-sm"><b>Continue Reading</b><i class="fa fa-angle-right ml-2"></i></a>
						</div>
					</div>
				</div>
			<?php endforeach ?>
