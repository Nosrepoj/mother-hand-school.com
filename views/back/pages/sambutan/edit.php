<div class="container">
	...
	<?= form_open_multipart($form_action) ?>
		...
		<div class="form-group row">
			<label for="sambutan" class="col-sm-2 col-form-label">Quotes</label>
			<div class="col-sm-8">
		...
		<div class="row mt-4">
			<div class="col-8 offset-2">
				<a href="<?= base_url('sambutan') ?>" class="btn btn-sm btn-secondary"><i class="fas fa-angle-left mr-1"></i>Return</a>
