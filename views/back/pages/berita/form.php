<div class="container">
	...
	<?= form_open_multipart($form_action) ?>
		...
		<div class="form-group row">
			<label for="content" class="col-sm-2 col-form-label">Event content</label>
			<div class="col-sm-10">
		...
		<div class="row mt-4">
			<div class="col-10 offset-2">
				<a href="<?= base_url('berita') ?>" class="btn btn-sm btn-secondary"><i class="fas fa-angle-left mr-1"></i>Return</a>
